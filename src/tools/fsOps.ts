...
function formatError(action: string, filePath: string, error: Error) {
...
export function readFile(filePath: string) {
    ...
    try {
        ...
        return formatError('reading', filePath, error as Error);
    }
}
...
export function writeFile(filePath: string, content: string) {
    ...
    try {
        ...
        return formatError('writing', filePath, error as Error);
    }
}

export function editFile(filePath: string, oldContent: string, newContent: string) {
    const safePath = resolveWorkspacePath(filePath);
    ...
    try {
        ...
        return formatError('editing', filePath, error as Error);
    }
}
